<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestsForm.aspx.cs" Inherits="Dopravio_Web.RequestsForm" %>
...
<body>
    <form runat="server" visible="true" id="formData">
     <asp:ScriptManager runat="server" ID="sm">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        <li ><a href="HomeForm.aspx">Reporty</a></li>
                        <li class="active"><a href="RequestsForm.aspx">Žiadosti</a></li>
        ...
        <asp:HiddenField ClientIDMode="Static"  ID="lbAction" runat="server"/>
        
        <asp:HiddenField ClientIDMode="Static"  ID="lbId" runat="server"/>
            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-left" style="background-color: white; margin-top: 50px; padding: 20px;">
                    ...
                    <div class="col-sm-6 text-right">
                        <button type="button" class="btn btn-info btn-lg" style="margin-top: 20px;" data-toggle="modal" data-target="#myModal" disabled="disabled">Pridať žiadosť </button>
                            ...
                            <div class="modal-dialog modal-lg" style="margin-top: 100px;">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h1 class="modal-title">Zadajte odvôvodnenie</h1>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:Button runat="server" ID="btnSave" Text="Odoslať" CssClass="btn btn-primary" OnClick="btnSave_Click" AutoPostback="false" />
                    ...
                    <asp:Table ID="tableRequests" runat="server" Width="100%">
                        <asp:TableRow>
                            <asp:TableCell>Vytvorené</asp:TableCell>
                            <asp:TableCell>Stav</asp:TableCell>
                            <asp:TableCell>Typ</asp:TableCell>
                            <asp:TableCell>Priorita</asp:TableCell>
                            <asp:TableCell>Správa</asp:TableCell>     
                            <asp:TableCell>Odpoveď</asp:TableCell>                          
                            <asp:TableCell>Akcia</asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </div>
                <div class="col-sm-2 sidenav">
