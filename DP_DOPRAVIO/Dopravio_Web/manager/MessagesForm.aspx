<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessagesForm.aspx.cs" Inherits="Dopravio_Web.manager.MessagesForm" %>


<!DOCTYPE html>
<html lang="en">
<head>
    <title>Správy - manager</title>
    <meta charset="utf-8">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="MessagesForm.aspx">Správy</a></li>
            ...
            <div class="row content">
                ...
                <div class="col-sm-8 text-left" style="background-color: white; margin-top: 50px; padding: 20px;">
                    ...
                    <div class="col-sm-6 text-right">
                        <button type="button" class="btn btn-info btn-lg" style="margin-top: 20px;" data-toggle="modal" data-target="#myModal" disabled="disabled">Pridať správu</button>
                    ...
                    <asp:Table ID="tableMessages" runat="server" Width="100%">
                        <asp:TableRow>
                            <asp:TableCell>Vytvorené</asp:TableCell>
                            <asp:TableCell>Od</asp:TableCell>
