<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeesForm.aspx.cs" Inherits="Dopravio_Web.manager.EmployeesForm" %>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Zamestnanci - manager</title>
    <meta charset="utf-8">
     ...
     <asp:ScriptManager runat="server" ID="sm">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="EmployeesForm.aspx">Zamestnanci</a></li>
                    </ul>
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                ...
                <div class="col-sm-8 text-left" style="background-color: white; margin-top: 50px; padding: 20px; margin-bottom:70px;">
                    <div class="col-sm-6">
                        <h1>Zamestnanci</h1>
                    </div>
                   <%-- <div class="col-sm-6 text-right">
                                    ...
                                    <div class="modal-footer">
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:Button runat="server" ID="btnSave" Text="Uložiť" CssClass="btn btn-primary" OnClick="btnSave_Click"s AutoPostback="false" />
                    ...
                    <asp:Table ID="tableEmployees" runat="server" Width="100%">
                        <asp:TableRow>
                            <asp:TableCell>Funkcia</asp:TableCell>
                            <asp:TableCell>Meno</asp:TableCell>
                            <asp:TableCell>Priezvisko</asp:TableCell>
                            <asp:TableCell>Email</asp:TableCell>
                            <asp:TableCell>Telefon</asp:TableCell>
                            <asp:TableCell>Plat</asp:TableCell>
                        </asp:TableRow>
                    </asp:Table>
                </div>
                <div class="col-sm-2 sidenav">
